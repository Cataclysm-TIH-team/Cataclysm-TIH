        ...
        switch( sel ) {
            case 1: {
                ...
                if( u.str_max >= HIGH_STAT ) {
                    mvwprintz( w, point( iSecondColumn, 3 ), c_light_red,
                               _( "Increasing Strength further costs 2 points" ) );
                }
                u.recalc_hp();
                u.set_stored_kcal( u.get_healthy_kcal() );
            ...
            case 2: {
                ...
                if( u.dex_max >= HIGH_STAT ) {
                    mvwprintz( w, point( iSecondColumn, 3 ), c_light_red,
                               _( "Increasing Dexterity further costs 2 points" ) );
                }
            ...
            case 3: {
                ...
                if( u.int_max >= HIGH_STAT ) {
                    mvwprintz( w, point( iSecondColumn, 3 ), c_light_red,
                               _( "Increasing Intelligence further costs 2 points" ) );
                }
            ...
            case 4: {
                ...
                if( u.per_max >= HIGH_STAT ) {
                    mvwprintz( w, point( iSecondColumn, 3 ), c_light_red,
                               _( "Increasing Perception further costs 2 points" ) );
                }
