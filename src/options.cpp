...
void options_manager::add_options_general()
{
    ...
    add( "PROMPT_ON_CHARACTER_DEATH", "general", to_translation( "Prompt on character death" ),
         to_translation( "If false, when your character die, it's unavoidable: savefile is automatically deleted and character is put into the graveyard.  If true, on character death the player is prompted to cancel savefile deletion and return to main menu instead." ),
         false
       );
...
void options_manager::add_options_world_default()
{
    ...
    to_translation( "Sets eternal weather.  'Normal' clears all eternal weather overrides and sets normal weather pattern.  Requires restart of the game after changing value to take effect." ), {
        { "normal", to_translation( "Normal" ) },
        ...
        { "rainstorm", to_translation( "Rainstorm" ) },
